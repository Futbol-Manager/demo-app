...
@Component({
  selector: 'app-entrenamientos-creados',
  templateUrl: './entrenamientos-creados.component.html',
  styleUrls: ['./entrenamientos-creados.component.scss']
})
export class EntrenamientosCreadosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.clubService.getEntrenamientosCreados(this.clubId).subscribe(
      (response: Response) => {
        ...
        if (response.data !== null) {
          ...
          setTimeout(() => {
            this.graficaUnica();
            // Ocultar el spinner una vez cargada la gráfica
            this.loading = false;
          }, 1000);
        } else {
