...
import { ErpPayment, ERP_PAYMENT_METHODS } from '../models/erp.models';
...
export class ErpPaymentsComponent implements OnInit {
  ...
  openNew(type: string): void {
    this.form = { paymentType: type, postingDate: new Date().toISOString().substring(0, 10), partyName: '', paidAmount: 0, paymentMethod: 'BankTransfer', referenceNumber: '', remarks: '' };
    this.showForm = true;
  }
