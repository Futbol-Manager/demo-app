...
@Component({
  selector: 'app-horariosequipos',
  templateUrl: './horariosequipos.component.html',
  styleUrls: ['./horariosequipos.component.scss']
})
export class HorariosequiposComponent implements OnInit {
