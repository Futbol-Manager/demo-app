    ...
    this.parentForm = this.fb.group(
      {
        ...
        name: ['PRUEB1', Validators.required],
        surname: ['PRUEBA2', Validators.required],
        birthdate: [
          '1966-12-11',
          [Validators.required, this.adultValidator.bind(this)],
        ],
        genre: ['1', Validators.required],
        email: ['a@mail.com', [Validators.required, Validators.email]],
        confirmEmail: ['a@mail.com', [Validators.required, Validators.email]],
        phone: ['12321312', [Validators.required]],
