...
export class ClubCuotas {
    ...
    constructor(object: any) {
        ...
        this.cuotaUno = object.cuotaUno ? object.cuotaUno : '';
        this.cuotaDos = object.cuotaDos ? object.cuotaDos : '';
        this.cuotaTres = object.cuotaTres ? object.cuotaTres : '';
        this.cuotaCuatro = object.cuotaCuatro ? object.cuotaCuatro : '';
        this.cuotaCinco = object.cuotaCinco ? object.cuotaCinco : '';
        this.cuotaSeis = object.cuotaSeis ? object.cuotaSeis : '';
        this.cuotaSiete = object.cuotaSiete ? object.cuotaSiete : '';
        this.cuotaOcho = object.cuotaOcho ? object.cuotaOcho : '';
        this.cuotaNueve = object.cuotaNueve ? object.cuotaNueve : '';
        this.cuotaDiez = object.cuotaDiez ? object.cuotaDiez : '';
        this.cuotaOnce = object.cuotaOnce ? object.cuotaOnce : '';
        this.cuotaDoce = object.cuotaDoce ? object.cuotaDoce : '';
